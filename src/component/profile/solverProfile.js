...
class SolverProfile extends React.Component {
  ...
  render() {
    let summary = [
      <MiniCard
        key="solver-voted"
        value={this.props.profile.data.asset.vote.length}
        label="Dispute Voted"
      />,
      <MiniCard
        key="solver-winrate"
        value={
          this.props.profile.data.asset.win +
            this.props.profile.data.asset.lose >
          0
            ? (
                (this.props.profile.data.asset.win /
                  (this.props.profile.data.asset.win +
...
export default withRouter(SolverProfile);
